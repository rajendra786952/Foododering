...
export class DishdetailsComponent implements OnInit {
  ...
  onClick(i:string,v:any):void{
   var numberValue :any= Number(i);
   var t:any= this.dishes[numberValue].raj=false;
   if(this.price>0)
   {
     this.value++;
   }
  ...
  onincrement(v:any,i:any):void{
    this.value++;
    this.price+=v;
    var numberValue :any= Number(i);
   this.dishes[numberValue].value++;
}
  ondecrement(v:any,i:any):void{
    this.value--;
    this.price-=v;
    var numberValue :any= Number(i);
    this.dishes[numberValue].value--;
    if(this.dishes[numberValue].value==0)
    {
      this.dishes[numberValue].raj=true;
      this.dishes[numberValue].value=1;
      this.value=1;
    }
}
